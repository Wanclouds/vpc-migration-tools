...
function isValidOs() {
	try {
		$boolIsValid = $False;
		$arrstrAllowedOSes = @( 'Microsoft Windows Server 2025 Standard', 'Microsoft Windows Server 2022 Standard', 'Microsoft Windows Server 2019 Standard', 'Microsoft Windows Server 2016 Standard','Microsoft Windows Server 2012 R2 Standard','Microsoft Windows Server 2012 Standard');
...
function getCertificatePath( $strDriveLetter ) {
	...
	switch ( $strOsName ) {
	    "Microsoft Windows Server 2025 Standard" { $strPath = "$strDriveLetter\amd64\2k25"; Break; }
